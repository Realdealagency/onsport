...
var app = {
 ...
 //inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
     	var   inAppBrowserbRef = cordova.InAppBrowser.open('https://ramadan.ovplatform.tk/Mosalsallat/my_eposide/176', '_self', 'location=no,toolbar=no','clearcache=yes','clearsessioncache=yes','zoom=no','hardwareback=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: ' ca-app-pub-7251676025279948/3676640962',		//PUT ADMOB ADCODE HERE 
                    interstitial: ' ca-app-pub-7251676025279948/5884959766'	//PUT ADMOB ADCODE HERE 
                }
            };
