...
var app = {
 ...
 //inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
     	var   inAppBrowserbRef = cordova.InAppBrowser.open('http://games.realdeal.com.eg/?i=290', '_self', 'location=no,toolbar=no','clearcache=yes','clearsessioncache=yes','zoom=no','hardwareback=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-5602387816569419/3534799682',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-5602387816569419/4245246128'	//PUT ADMOB ADCODE HERE 
                }
            };
