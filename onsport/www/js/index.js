...
var app = {
 ...
 //inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
     	var   inAppBrowserbRef = cordova.InAppBrowser.open('https://ramadan.ovplatform.tk/Mosalsallat/my_eposide/178', '_self', 'location=no,toolbar=no','clearcache=yes','clearsessioncache=yes','zoom=no','hardwareback=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-5602387816569419/2644146305',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-5602387816569419/6579769304'	//PUT ADMOB ADCODE HERE 
                }
            };
